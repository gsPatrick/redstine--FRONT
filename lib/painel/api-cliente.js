 ...
 *
 * Nao e um "pedido manual" a parte: a API cria o MESMO pedido, marcado com o
 * canal, e confirma-o na sequencia — e a confirmacao que baixa o estoque e
 * gera o repasse. Por isso o retorno e o pedido ja confirmado, e nao um
 * rascunho a espera de alguem clicar em confirmar.
 */
export const registrarVendaExterna = (dados) => post("/orders/external", dados);
