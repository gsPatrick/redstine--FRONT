 ...
 *
 * `site` esta na lista de rotulos porque a coluna precisa de o exibir, mas NAO
 * esta em CANAIS_EXTERNOS: registrar a mao uma venda como "site" tornaria a
 * coluna inutil justamente onde ela serve para algo.
 */
...
export const CANAIS_EXTERNOS = ["whatsapp", "telefone", "presencial", "outro"];
