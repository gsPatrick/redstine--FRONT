...
/*
 * Banners de topo: so as CAPAS (Home e Comprar) levam CTA.
 *
 * O cliente fechou o conteudo de cada nivel: capa e "somente titulo e 2 botoes
 * CTA"; interna principal e secundaria sao "titulo e texto de apoio de ate
 * duas linhas" — sem botao. Nao e so estetica: o botao era o que estourava a
 * altura do nivel e fazia o padrao nao ser padrao. A acao nao se perdeu, esta
 * no banner de encerramento, que agora existe em todas as paginas.
 */
export const vender = {
  hero: {
    image: HERO_STOCK,
  ...
  /**
   * Jornada de venda RESUMIDA, em quatro etapas.
   *
   * Eram sete, e o cliente nomeou exatamente as quatro que quer aqui: envio,
   * aprovação, comercialização, venda e repasse. As outras três (avaliação,
   * modelo e preço, publicação) não desapareceram: continuam na página Como
   * Funciona, que é onde o processo completo vive. Sete cartões numa página de
   * entrada fazem a pessoa ler a lista em vez de entender o caminho.
   *
   * Cada etapa resumida absorve o que ficou de fora, para o resumo não mentir
   * por omissão: aprovação carrega a avaliação e a definição de preço, e
   * comercialização carrega a publicação.
   */
  stepsTitle: "Jornada de venda resumida",
  steps: [
    {
      title: "ENVIO",
    ...
    },
    {
      title: "APROVAÇÃO",
      description:
        "A RED avalia condição, logística e potencial, propõe preço e modelo, e você aprova.",
      image: STEP_ICONS[1],
    },
    {
      title: "COMERCIALIZAÇÃO",
      description: "Os ativos aprovados entram no catálogo e a RED conduz a negociação.",
      image: STEP_ICONS[2],
    },
    {
...
export const entendaOsModelos = {
  hero: {
    image: HERO_WAREHOUSE,
    // Encurtado para caber no nível secundário de banner (240px), que o
    // cliente definiu como "título em 1 linha e texto de apoio de até duas
    // linhas". O texto completo continua no corpo da página, que é onde ele
    // tem espaço para ser lido.
    title: "Dois modelos comerciais, uma só gestão",
    subtitle:
      "A estrutura é definida pelo ativo: localização, volume, logística e potencial de venda.",
  },
  models: [
    {
      id: "estoque",
