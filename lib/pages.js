...
export const comoFunciona = {
  ...
  curationCta: { label: "Enviar Ativos", href: "/vender#enviar" },
  ...
  ctaActions: [
    { label: "Enviar Ativos", href: "/vender", variant: "accent" },
...
export const entendaOsModelos = {
  hero: {
    ...
    actions: [{ label: "Enviar Ativos", href: "/vender#enviar", variant: "solid" }],
  },
  models: [
    {
      id: "estoque",
  ...
  ctaAction: { label: "Enviar Ativos", href: "/vender#enviar" },
};
