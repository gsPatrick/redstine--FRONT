 ...
 * Circularidade.
 *
 * `items` virou lista de objetos na revisão do item 36. O desenho anterior era
 * um anel com cinco rótulos de 13px e um vazio de 500px no meio: ocupava uma
 * tela inteira para dizer cinco palavras. Cada etapa passa a carregar uma
 * linha de explicação — é o que justifica o espaço que o bloco ocupa.
 */
  ...
  items: [
    {
      ...
      detail: "O ativo que sobra de uma operação entra em uso em outra.",
    },
    {
      label: "Redução de perdas",
      detail: "Menos material parado, obsoleto ou descartado sem necessidade.",
    },
    {
      label: "Destinação organizada",
      detail: "Condição, quantidade e destino registrados a cada movimentação.",
    },
    {
      label: "Novos ciclos de uso",
      detail: "O comprador de hoje é o fornecedor da próxima desmobilização.",
    },
    {
      label: "Circularidade aplicada",
      detail: "Circularidade que acontece na operação, não no discurso.",
    },
  ],
  // Fecha a ideia sem repetir uma das etapas.
  closing: "O ativo segue produtivo.",
  cta: null,
};
